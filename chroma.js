...
function takeScreenshot() {
  ...
  originalImage.src = c1.toDataURL("image/png").replace("image/png", "image/octet-stream");
  ...
  var image = c1.toDataURL("image/png").replace("image/png", "image/octet-stream");
